...
export default function Homebar(props) {
    ...
    return (
        <div className="homebar">
            ...
            <Tooltip id="tooltip" title="delete last page" TransitionProps={{ timeout: 0 }} placement="right">
                <IconButton id="iconButton" variant="contained" onClick={() => props.deletePage()}>
