        ...
        <SubMenuWrap>
            ...
            {isAuthorized() && (
                <>
                    <MenuItem
                        text={
                            <FormattedMessage id="Menu.General.Theme.Apple" />
                        }
                    ...
                    <MenuItem
                        text={
                            <FormattedMessage id="Menu.General.Theme.Candy" />
                        }
                    ...
                    <MenuItem
                        text={
                            <FormattedMessage id="Menu.General.Theme.Ocean" />
                        }
                    ...
                    <MenuItem
                        text={
                            <FormattedMessage id="Menu.General.Theme.Orange" />
                        }
                    ...
                    <MenuItem
                        text={
                            <FormattedMessage id="Menu.General.Theme.Purple" />
                        }
